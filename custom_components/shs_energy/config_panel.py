...
CONTROL_FIELDS: dict[str, tuple[dict[str, Any], ...]] = {
    ...
    "switch_schedule": (
        ...
        _field(
            ...
            "entity",
            domains=("number", "input_number"),
            help_text="Optional. For equipment that runs to a temperature band rather than an on/off command; the planner moves the band and the machine still picks when to run.",
        ),
        _field(
