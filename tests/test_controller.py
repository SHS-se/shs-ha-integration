...
class ControllerTests(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        self.states = {
            ...
            'sensor.house_power': State(1000, unit_of_measurement='W', state_class='measurement'),
            'sensor.solar_power': State(0, unit_of_measurement='W', state_class='measurement'),
            'sensor.grid_power': State(1000, unit_of_measurement='W', state_class='measurement'),
        ...
        self.options = {
            ...
            **{f'{d}_enabled': True for d in ('battery', 'ev', 'pool')},
            ...
            'house_consumption_power_entity': 'sensor.house_power',
            'solar_production_power_entity': 'sensor.solar_power', 'grid_power_entity': 'sensor.grid_power',
